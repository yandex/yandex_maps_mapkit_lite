...
extension LocationPurposeContainerExtension on LocationPurpose {
  static ffi.Pointer<ffi.Void> toNativeMap(
      core.Map<core.String, LocationPurpose?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }

    return string_map.toNativeMap(obj, LocationPurposeImpl.toPointer);
  }

  static ffi.Pointer<ffi.Void> toNativeMapVector(
      core.Map<core.String, core.List<LocationPurpose?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeMapDictionary(
      core.Map<core.String, core.Map<core.String, LocationPurpose?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(
      core.List<LocationPurpose?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }

    return vector.toNativeVector(obj, LocationPurposeImpl.toPointer);
  }

  static ffi.Pointer<ffi.Void> toNativeVectorVector(
      core.List<core.List<LocationPurpose?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeVectorDictionary(
      core.List<core.Map<core.String, LocationPurpose?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static string_map.StringMap<LocationPurpose> toPlatformMap(
      ffi.Pointer<ffi.Void> ptr) {
    return string_map.StringMap(
        ptr, (val) => LocationPurposeImpl.fromPointer(val, needFree: false));
  }

  static string_map.StringMap<vector.Vector<LocationPurpose>>
      toPlatformMapVector(ffi.Pointer<ffi.Void> ptr) {
    return string_map.StringMap(
        ptr,
        (val) => val == ffi.nullptr
  ...
  static string_map.StringMap<string_map.StringMap<LocationPurpose>>
      toPlatformMapDictionary(ffi.Pointer<ffi.Void> ptr) {
    return string_map.StringMap(
        ptr,
        (val) => val == ffi.nullptr
  ...
  static vector.Vector<LocationPurpose> toPlatformVector(
      ffi.Pointer<ffi.Void> ptr) {
    return vector.Vector(
        ptr, (val) => LocationPurposeImpl.fromPointer(val, needFree: false));
  }

  static vector.Vector<vector.Vector<LocationPurpose>> toPlatformVectorVector(
      ffi.Pointer<ffi.Void> ptr) {
    return vector.Vector(
        ptr,
        (val) => val == ffi.nullptr
  ...
  static vector.Vector<string_map.StringMap<LocationPurpose>>
      toPlatformVectorDictionary(ffi.Pointer<ffi.Void> ptr) {
    return vector.Vector(
        ptr,
        (val) => val == ffi.nullptr
