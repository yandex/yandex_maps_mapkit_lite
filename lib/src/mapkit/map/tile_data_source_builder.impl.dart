...
final void Function(
    ...
    .lookup<
        ...
        'yandex_flutter_mapkit_map_TileDataSourceBuilder_setTileUrlProvider')
    .asFunction();
    ...
    _TileDataSourceBuilder_setTileProvider = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'yandex_flutter_mapkit_map_TileDataSourceBuilder_setTileProvider')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _TileDataSourceBuilder_setProjection = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'yandex_flutter_mapkit_map_TileDataSourceBuilder_setProjection')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _TileDataSourceBuilder_setZoomRanges = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'yandex_flutter_mapkit_map_TileDataSourceBuilder_setZoomRanges')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int)
    _TileDataSourceBuilder_setTileFormat = lib.library
        .lookup<
            ...
            'yandex_flutter_mapkit_map_TileDataSourceBuilder_setTileFormat')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int)
