...
extension CircleMapObjectContainerExtension on CircleMapObject {
  static ffi.Pointer<ffi.Void> toNativeMap(
    ...
    return string_map.toNativeMap(obj, CircleMapObjectImpl.getNativePtr);
  }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(
    ...
    return vector.toNativeVector(obj, CircleMapObjectImpl.getNativePtr);
  }
  ...
  static string_map.StringMap<CircleMapObject> toPlatformMap(
    ...
    return string_map.StringMap(
        ptr,
        (val) => CircleMapObjectImpl.fromOptionalPtr(
  ...
  static vector.Vector<CircleMapObject?> toPlatformVectorOptional(
      ffi.Pointer<ffi.Void> ptr) {
    return vector.Vector(
        ptr,
        (val) => CircleMapObjectImpl.fromOptionalPtr(
  ...
  static vector.Vector<vector.Vector<CircleMapObject>?>
