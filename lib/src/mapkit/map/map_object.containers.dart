...
extension MapObjectContainerExtension on MapObject {
  static ffi.Pointer<ffi.Void> toNativeMap(
    ...
    return string_map.toNativeMap(obj, MapObject.getNativePtr);
  }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(core.List<MapObject?>? obj) {
    ...
    return vector.toNativeVector(obj, MapObject.getNativePtr);
  }
  ...
  static string_map.StringMap<MapObject> toPlatformMap(
    ...
    return string_map.StringMap(
        ptr,
        (val) =>
            MapObject.fromOptionalPtr(val.cast<ffi.Pointer<ffi.Void>>().value));
  }
