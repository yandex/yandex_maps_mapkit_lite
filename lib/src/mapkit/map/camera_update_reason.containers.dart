...
extension CameraUpdateReasonContainerExtension on CameraUpdateReason {
  static ffi.Pointer<ffi.Void> toNativeMap(
      core.Map<core.String, CameraUpdateReason?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeMapVector(
      core.Map<core.String, core.List<CameraUpdateReason?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeMapDictionary(
      core.Map<core.String, core.Map<core.String, CameraUpdateReason?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(
      core.List<CameraUpdateReason?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeVectorVector(
      core.List<core.List<CameraUpdateReason?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeVectorDictionary(
      core.List<core.Map<core.String, CameraUpdateReason?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static string_map.StringMap<string_map.StringMap<CameraUpdateReason>>
