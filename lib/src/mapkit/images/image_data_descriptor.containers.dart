...
extension ImagesImageDataDescriptorContainerExtension
    on ImagesImageDataDescriptor {
  static ffi.Pointer<ffi.Void> toNativeMap(
      core.Map<core.String, ImagesImageDataDescriptor?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeMapVector(
      core.Map<core.String, core.List<ImagesImageDataDescriptor?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeMapDictionary(
      core.Map<core.String, core.Map<core.String, ImagesImageDataDescriptor?>?>?
          obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(
      core.List<ImagesImageDataDescriptor?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeVectorVector(
      core.List<core.List<ImagesImageDataDescriptor?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static ffi.Pointer<ffi.Void> toNativeVectorDictionary(
      core.List<core.Map<core.String, ImagesImageDataDescriptor?>?>? obj) {
    if (obj == null) {
      return ffi.nullptr;
    }
  ...
  static string_map.StringMap<string_map.StringMap<ImagesImageDataDescriptor>>
